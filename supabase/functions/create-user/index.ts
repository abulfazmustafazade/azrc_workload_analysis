...
// ============================================================================
// İstifadəçi yaratmaq service_role açarı tələb edir — bu açar HEÇ VAXT
// frontend kodunda olmamalıdır. Ona görə bu əməliyyat server-side Edge
// Function-da aparılır. Frontend yalnız bu funksiyanı çağırır (anon key ilə),
// funksiya öz daxilində service_role ilə işləyir.
//
// Deploy:
//   supabase functions deploy create-user
//
// Çağıran tərəfdə (db.js → usersApi.create) artıq hazırdır:
